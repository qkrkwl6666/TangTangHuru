...
public class AhievementTask
{
    ...
    public void AddProgress(string key) //�ش� �������� ���൵ ����
    {
    ...
    public void AddProgress(string key, int num) //�ش� �������� ���൵ ����
    {
        if (progressValues.ContainsKey(key))
        {
    ...
    public int GetProgress(string key) //���� ���൵ Ȯ��
    {
        if (progressValues.ContainsKey(key))
        {
    ...
    public int GetCondition(string key) //�޼� ���� Ȯ��
    {
    ...
    {
        SavedAchieveProgress.Clear(); // 기존 데이터 초기화 후 저장
