...
public class MainInventory : MonoBehaviour
{
    ...
    public List<TextMeshProUGUI> playerStatusTexts = new(); // ���� �ؽ�Ʈ

    public List<TextMeshProUGUI> equipmentTextUI = new(); // ���׷��̵� �ؽ�Ʈ   ���ٽ� (PlayerEquipment) - 1 
    ...
    public Item LoadMakeItem(Item item,ItemData itemData, int instanceId = 0)
    {
        switch (item.ItemType)
        {
            ...
            case ItemType.ReinforcedStone: // ��ȭ��
    ...
    public void LoadDataPlayerEquip()
    {
        ...
        foreach (var item in playerEquipment)
        {
            if (item.Value.Item1.ItemType == ItemType.Pet)
            {
                LoadEquipPet(item.Value);
                continue;
            }
    ...
    /// <summary>
    /// 방어구 착용 시 해당 세트/부위의 도전과제 진행도 등록
    /// </summary>
